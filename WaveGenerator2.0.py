...
Total_Points = 1400  # Set your total points value here
    ...
    if ros_file_path:
        ...
        for force in forces:
            ...
            for unit in selections:
                ...
                #print(f"Found unit: {unique_unit_name}")
                ...
                total_points = base_points + upgrade_points
                unit_entries.append((unique_unit_name, total_points))
